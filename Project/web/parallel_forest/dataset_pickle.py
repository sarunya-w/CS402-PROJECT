...
class dataset:
    def __init__(self,index=0):
        ...
        import pickle
        self.index=index
        self.path='../parallel_forest/training/dataset%02d.pic'%(self.index)
        pickleFile = open(self.path, 'rb')
        self.clmax,self.theta_dim,self.theta_range,self.size,self.samples,self.I,self.pos = pickle.load(pickleFile)
