...
Requirements
You just need IPython.parallel
...
2) Starting ipcluster. Here you can check the instruction in the Ipython website. If you are using TU-Scicloud please check the tutorial here
